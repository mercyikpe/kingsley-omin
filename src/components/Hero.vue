<template>
	<main class="bg-white relative font-Graphik">
		...
		<section class="relative py-6">
			<div class="container px-4 lg:px-0 mx-auto flex flex-col sm:flex-row items-center relative">
				...
				<div class="items-center justify-center xl:justify-end w-full lg:w-1/2 xl:w-4/6 lg:py-20">
					<img class="h-full w-full lg:w-4/5" src="https://res.cloudinary.com/mercyikpe/image/upload/v1596703082/kingsley%20omin/ko.png" alt="Kingsley Omin">
				</div>
			</div>
			<div class="absolute right-0 top-0 mt-24 pt-3 mr-12 hidden lg-flex">
				<Icon
						name="light-switch"
